...
import { copyrightService, DocumentMetadata, DocumentCopyright, CopyrightStats } from '@/features/copyright/api/blockchainCopyrightService';
...
export function useCopyrightAdmin() {
...
export default useCopyrightAdmin;
